      ...
      <nav class="navbar navbar-expand-lg  bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="daftar_menu.php">TAMBAH KATALOG</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <?php $totalbelanja = 0; ?>
          <?php 
              $ambil = $koneksi->query("SELECT * FROM pesanan JOIN katalog ON pesanan.id_menu=katalog.id_menu 
                WHERE pesanan.id_pesanan='$_GET[id]'");
           ?>
           <?php while ($pecah=$ambil->fetch_assoc()) { ?>

           <?php 
              $_SESSION['id_pesanan_tb'] = $pecah['id_pesanan'];
              $_SESSION['id_menu_katalog'] = $pecah['id_menu'];
              // echo  $_SESSION['id_menu_katalog'];
              // $id_pesanan_baru =  $_SESSION['id_pesanan_tb'];

              // echo $id_pesanan_baru;
           ?>
