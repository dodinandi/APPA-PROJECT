...
<html lang="en">
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_menu_traveling.php" class="btn btn-success mt-3">TAMBAH DAFTAR KATALOG</a>
        <div class="row">
          ...
          $query = mysqli_query($koneksi, 'SELECT * FROM travelling');
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="edit_menu_traveling.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>

                <a href="hapus_menu_traveling.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endforeach; ?>
