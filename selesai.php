...
<html lang="en">
  <head>
    ...
    <title>HASIL PEMOTRETAN</title>
  </head>
  <body>
 
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">HASIL PEMOTRETAN</h3>
    <div class="card p-5 mb-5">
     ...
     if(isset($_POST['upload'])) {
        ...
        //   echo $total_belanja_prod;
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO selesai (id_menu, nama, tanggal_selesai, hasil_pemotretan) VALUES ('$id_menu', '$nama', '$tanggal_selesai', '$hasil_foto')");
          ...
          echo "<script>location='photographer.php'</script>";
      }
      ?>
    </div>
  </div>
