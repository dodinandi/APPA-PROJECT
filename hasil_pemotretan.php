  ...
  <!-- Menu -->
      <div class="container">
        <div class="row mt-3">
          ...
          include('koneksi.php');
          $id_menu =  $_SESSION['id_menu_hp'];
          $query = mysqli_query($koneksi, "SELECT * FROM selesai WHERE id_menu = '$id_menu'");
          ...
          <?php foreach($result as $result) : ?>
            ...
            <div class="card brder-dark">
              <img src="upload/dnl.jpg" class="card-img-top" alt="...">
              <div class="card-body">
              <?php $foto = $result['hasil_pemotretan'];?>
              <?php $_SESSION['nama_file'] = $result['hasil_pemotretan'];?>
                <a href="download.php?id_menu=<?php echo $result['id_menu'];?>" class="btn btn-success btn-sm btn-block" JavaScript:window.location.href="download.php?file=".$foto >DOWNLOAD</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
