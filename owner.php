...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="owner.php"><strong>APPA</strong> PROJECT</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-4" href="owner.php">HOME</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="laporan_pemesanan.php">LAPORAN PEMESANAN</a>
            </li>
            <li class="nav-item">
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="laporan_pemesanan.php" class="btn btn-primary">LAPORAN PEMESANAN</a>
              </div>
            </div>
          </div>
